...
const TopNavigation = ({ setDrawerOpen }: Props) => {
  return (
    <div className="hidden md:flex z-50 justify-start px-6 gap-6 items-center fixed top-0 left-0 right-0 h-16 bg-gray-100 bg-opacity-90 backdrop-filter backdrop-blur-sm dark:bg-gray-900 dark:bg-opacity-90">
